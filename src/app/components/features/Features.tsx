        ...
        <div className='container'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[52px] paddingVertical'>
                ...
                <div>
                    ...
                    <p className='text-[#030303] text-[32px] leading-[45px] font-semibold pt-[16px]'>It’s one of the leading online flight booking platforms in the world</p>
                    <div className='py-[40px]'>
                        <div className='flex gap-3  items-center'>
                            <Image src={circle} alt='circle' />
                            <p className='text-[#030303] text-[16px] leading-[28px] font-medium	'>Contrary to popular belief, Lorem Ipsum is not simply random text</p>
                        </div>
                        <div className='flex gap-3  items-center pt-[10px]'>
                            <Image src={circle} alt='circle' />
                            <p className='text-[#030303] text-[16px] leading-[26px] font-medium	'>If you are going to use a passage of Lorem Ipsum</p>
                        </div>
                        <div className='flex gap-3  items-center pt-[10px]'>
                            <Image src={circle} alt='circle' />
                            <p className='text-[#030303] text-[16px] leading-[26px] font-medium	'>If you are going to use a passage of Lorem Ipsum</p>
